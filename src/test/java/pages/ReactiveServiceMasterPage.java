...
//
    ...
    //Service Request Reasons Pagination and Data per page starts
    public void ServiceRequestReasonsPagination(String ServiceRequestReasonsPagination) throws InterruptedException {
        try {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            WebElement firstRowBefore = wait.until(ExpectedConditions.presenceOfElementLocated(
                    By.xpath("//*[@id='ctl00_ContentPlaceHolder1_grdSRReason']")));
            String beforeText = firstRowBefore.getText();
            WebElement nextBtn = driver.findElement(By.xpath("//*[@id='ctl00_ContentPlaceHolder1_grdSRReason_ctl00_Pager']/tbody/tr/td/table/tbody/tr/td/div[3]/input[1]"));
            nextBtn.click();
            wait.until(ExpectedConditions.stalenessOf(firstRowBefore));
            WebElement firstRowAfter = wait.until(ExpectedConditions.presenceOfElementLocated(
                    By.xpath("//*[@id='ctl00_ContentPlaceHolder1_grdSRReason']")));
            ...
            System.out.println("Pagination failed: Data did not change" + ServiceRequestReasonsPagination);
            throw e;
        }
    }
    //Service Request Reasons data per page check Starts
    public void ServiceRequestReasonsDataPerPage(int expectedSize) {
        WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(By.id("ctl00_ContentPlaceHolder1_grdSRReason_ctl00_ctl03_ctl01_PageSizeComboBox_Arrow")));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", dropdown);
        dropdown.click();
        WebElement option = wait.until(
                ExpectedConditions.elementToBeClickable(
