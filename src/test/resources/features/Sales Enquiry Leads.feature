...
Feature: Sales Enquiry Management Leads Transaction Module Automation
  ...
  Scenario: Should be able to add Open Enquiry Detail page and click Skip Site Survey
    ...
    When User fills the Enquiry Update Status Pop Up details
  ...
  Scenario: Should be able to add Open Enquiry Detail page and Move enquiry to Site Survey Requested
    ...
    When User clicks on first data in the grid to Open the Detail page
    When User Clicks on status Update Button 'Status Update' in Enquiry Detail Page
    When User fills the Enquiry Site Survey Requested Update Status Pop Up details
  ...
  Scenario: Should be able to add Open Enquiry Detail page and Move enquiry to Cancelled
    ...
    When User clicks on first data in the grid to Open the Detail page
    When User Clicks on status Update Button 'Status Update' in Enquiry Detail Page
    When User fills the Enquiry Update Status Pop Up Cancelled details
    Then User Clicks on Enquiry Update Status Save Button
  ...
  Scenario: Should be able to Open Enquiry Detail page and Add Customer Follow Up
    ...
    When User enters the Customer Follow Up Details
  ...
  Scenario: Should be able to Open Enquiry Detail page and Add Enquiry Notes
    ...
    When User Clicks on Add Notes 'Notes'
    When User enters the Notes Details
...
#prod Package
  ...
  Scenario: Should be able to Open Prod Package detail page
    ...
    When User clicks on Sales Enquiry Management 'Sales Enquiry Management' in side menu
    When User clicks on Sales Enquiry Management Package Product 'Product Store Front' in side menu
    When User clicks on first data in the Product Store Front grid to Open the Detail page
  ...
  Scenario: Should be able to Open Prod Package detail page and add Product Pricing
    ...
    When User clicks Add New Product Pricing 'Add New' Button
  ...
  Scenario: Should be able to Open Prod Package detail page and Edit Product Pricing
    ...
    When User clicks Add New Product Pricing 'Add New' Button
    When User enters Product Pricing details
    When User Clicks on Product Pricing Save Button
...
#Rate Card
  ...
  Scenario: Should be able to Edit Rate Card
    ...
    When User clicks on Sales Enquiry Management 'Sales Enquiry Management' in side menu
    When User clicks on Sales Enquiry Management Rate Card 'Product Rate Card' in side menu
    When User clicks on first data in the Rate Card grid to Open the Detail page
...
#Rate Card
  ...
  Scenario: Should be able to Open Awaiting Approval Detail Page
    ...
    When User is at home screen after login with "username" and "password"
    When User clicks on Sales Enquiry Management 'Sales Enquiry Management' in side menu
    When User clicks on Sales Enquiry Management Awaiting Approval 'Awaiting Approval' in side menu
  ...
  Scenario: Should be able to Export To Excel Awaiting Approval
    ...
    When User clicks on Sales Enquiry Management 'Sales Enquiry Management' in side menu
    When User clicks on Sales Enquiry Management Leads 'Sales Enquiry Management Leads' in side menu
    When User clicks on Sales Enquiry Management Awaiting Approval 'My Pending Actions Awaiting Approval' in side menu
  ...
  Scenario: Should be able to Open Awaiting Quotation Approval Detail Page
    ...
    When User is at home screen after login with "username" and "password"
    When User clicks on Sales Enquiry Management 'Sales Enquiry Management' in side menu
    When User clicks on Sales Enquiry Management Awaiting Quotation Approval 'Awaiting Quotation Approval' in side menu
