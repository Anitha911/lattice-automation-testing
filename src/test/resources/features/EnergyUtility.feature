...
@EnergyUtilityManualReadingEntry
Scenario: Should be able to Save Manual Reading Entry
    Given User navigates to 'lattice.url' page
    Then User is at home screen after login with "username" and "password"
    Then User clicks on Energy Utility 'Energy Utility' in side menu
    Then User Clicks on Energy Utility Manual Entry 'Manual Entry' in side menu
    When User Enters the details in the Manual Entry page
